<template>
  <el-menu active-text-color="#c6e2ff" background-color="#2979ff" text-color="#ffffff" default-active="2"
    :collapse="computeds.isCollapse" router>
    <div class="logo">投票管理系统</div>
    <template v-for="menu in menus">
      ...
      <!-- 按钮 -->
      <el-menu-item class="menu-item" v-else :index="`/${menu.path}/${menu.children[0].path}`">
        <component class="icon" :is="menu.meta.icon"></component>
